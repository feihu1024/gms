package com.example.gms.common;
...
public class VectorTileUtil {
	...
	public static TileBox tile2BoundingBox(final String tableName, final int x, final int y, final int zoom) {
		TileBox tileBox=new TileBox();
		tileBox.setTableName(tableName);
